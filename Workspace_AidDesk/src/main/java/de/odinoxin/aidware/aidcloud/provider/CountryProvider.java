...
import de.odinoxin.aidware.aidcloud.service.CountryProviderService;
...
public class CountryProvider implements Provider<Country> {
    private static de.odinoxin.aidware.aidcloud.service.CountryProvider svc;

    private static de.odinoxin.aidware.aidcloud.service.CountryProvider getSvc() {
        if (svc == null) {
