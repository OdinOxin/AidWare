...
import de.odinoxin.aidware.aidcloud.service.ContactTypeProviderService;
...
public class ContactTypeProvider implements Provider<ContactType> {
    ...
    private static de.odinoxin.aidware.aidcloud.service.ContactTypeProvider svc;

    private static de.odinoxin.aidware.aidcloud.service.ContactTypeProvider getSvc() {
        if (svc == null) {
