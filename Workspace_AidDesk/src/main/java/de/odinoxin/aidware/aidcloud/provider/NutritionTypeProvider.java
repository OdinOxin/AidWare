...
import de.odinoxin.aidware.aidcloud.service.NutritionTypeProviderService;
...
public class NutritionTypeProvider implements Provider<NutritionType> {
    private static de.odinoxin.aidware.aidcloud.service.NutritionTypeProvider svc;

    private static de.odinoxin.aidware.aidcloud.service.NutritionTypeProvider getSvc() {
        if (svc == null) {
