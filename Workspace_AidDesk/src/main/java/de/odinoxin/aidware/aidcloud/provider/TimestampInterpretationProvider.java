...
import de.odinoxin.aidware.aidcloud.service.TimestampInterpretationProviderService;
...
public class TimestampInterpretationProvider implements Provider<TimestampInterpretation> {
    private static de.odinoxin.aidware.aidcloud.service.TimestampInterpretationProvider svc;

    private static de.odinoxin.aidware.aidcloud.service.TimestampInterpretationProvider getSvc() {
        if (svc == null) {
