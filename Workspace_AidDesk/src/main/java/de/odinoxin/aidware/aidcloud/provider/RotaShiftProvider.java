...
import de.odinoxin.aidware.aidcloud.service.RotaShiftProviderService;
...
public class RotaShiftProvider implements Provider<RotaShift> {
    private static de.odinoxin.aidware.aidcloud.service.RotaShiftProvider svc;

    private static de.odinoxin.aidware.aidcloud.service.RotaShiftProvider getSvc() {
        if (svc == null) {
