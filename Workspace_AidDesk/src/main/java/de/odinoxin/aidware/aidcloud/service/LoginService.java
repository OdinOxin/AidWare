 ...
 * 
 */
@WebServiceClient(name = "LoginService", targetNamespace = "http://aidcloud.odinoxin.de/", wsdlLocation = "http://SPUTNIK:15123/AidCloud/Login?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LOGINSERVICE_QNAME = new QName("http://aidcloud.odinoxin.de/", "LoginService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://SPUTNIK:15123/AidCloud/Login?wsdl");
    ...
    public Login getLoginPort() {
        return super.getPort(new QName("http://aidcloud.odinoxin.de/", "LoginPort"), Login.class);
    }
    ...
    public Login getLoginPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://aidcloud.odinoxin.de/", "LoginPort"), Login.class, features);
    }
