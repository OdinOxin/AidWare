...
import de.odinoxin.aidcloud.service.TrackedChangeProviderService;
import de.odinoxin.aiddesk.Login;
import de.odinoxin.aiddesk.plugins.RecordItem;
import de.odinoxin.aiddesk.plugins.TrackedChange;
...
public class TrackedChangeProvider {
    private static de.odinoxin.aidcloud.service.TrackedChangeProvider svc;

    private static de.odinoxin.aidcloud.service.TrackedChangeProvider getSvc() {
        if (svc == null) {
